...
public class ScustomerSqliteRepository implements ScustomerRepository{
    
    @Override
    public boolean save(Customer customer) {
        String sql = "INSERT INTO tb_s_customers (Name, Phone) VALUES (?, ?);";
        try {
    ...
    public boolean update(Customer newCustomer) {
        String sql = "UPDATE tb_s_customers SET Name = ?, Phone = ? WHERE Id = ?;";
    ...
    public boolean delete(int id) {
        String sql = "DELETE FROM tb_s_customers WHERE Id = ?";
    ...
    public Customer findById(int id) {
        String sql = "SELECT * FROM tb_s_customers WHERE Id = ?";
    ...
    public ArrayList<Customer> findAll() {
        ...
        String sql = "SELECT * FROM tb_s_customers;";
    ...
    public ArrayList<Customer> findBySearchWords(String searchWords) {
        ...
        String sql = "SELECT * FROM tb_s_customers WHERE Name LIKE '%" + searchWords +"%'";
    ...
    public Customer findByName(String name) {
        Customer customer = null;
        String sql = "SELECT * FROM tb_s_customers WHERE Name = ?";
